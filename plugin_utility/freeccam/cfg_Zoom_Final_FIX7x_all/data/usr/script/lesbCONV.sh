#!/bin/sh
echo "Stahování xxxLesbians.m3u"
echo "Downloading xxxLesbians.m3u"
...
sed -i "s/%/userbouquet.xxxLesbians.m3u.tv/" /etc/enigma2/bouquets.tv 
...
echo "#NAME xxxLesbians.m3u" > /etc/enigma2/userbouquet.xxxLesbians.m3u.tv
cat CCcam3 >> /etc/enigma2/userbouquet.xxxLesbians.m3u.tv
