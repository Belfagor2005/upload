...
#################################################
#################################################
cp /tmp/film.m3u /movie/SkTonline72.m3u
cd /
rm -rf /tmp/test
#################################################
[ -d /tmp/test ] || mkdir -p /tmp/test
...
sed -i "s/%/userbouquet.SkTonline72.m3u.tv/" /etc/enigma2/bouquets.tv 
...
echo "#NAME SkTonline72.m3u" > /etc/enigma2/userbouquet.SkTonline72.m3u.tv
cat /tmp/test/Rus10.m3u >> /etc/enigma2/userbouquet.SkTonline72.m3u.tv
rm -rf /tmp/test
cd /
