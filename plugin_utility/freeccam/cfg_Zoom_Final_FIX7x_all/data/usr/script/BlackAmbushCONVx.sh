...
sed -i "s/%/userbouquet.BlackAmbushxx.m3u.tv/" /etc/enigma2/bouquets.tv 
cd /tmp/test
...
#################################################
echo "#NAME BlackAmbushxx.m3u" > /etc/enigma2/userbouquet.BlackAmbushxx.m3u.tv
cat seznam4 >> /etc/enigma2/userbouquet.BlackAmbushxx.m3u.tv
cd /
rm -rf /tmp/test
###########################################################################################################
