#!/bin/sh
echo "Stahování xxAmateur.m3u"
echo "Downloading xxAmateur.m3u"
...
sed -i "s/%/userbouquet.xxAmateur.m3u.tv/" /etc/enigma2/bouquets.tv 

URL="https://www.eporner.com/cat/amateur/";
# Files
TMP=`mktemp -d`
cd / ${TMP}
...
echo "#NAME xxAmateur.m3u" > /etc/enigma2/userbouquet.xxAmateur.m3u.tv
cat CCcam3 >> /etc/enigma2/userbouquet.xxAmateur.m3u.tv
