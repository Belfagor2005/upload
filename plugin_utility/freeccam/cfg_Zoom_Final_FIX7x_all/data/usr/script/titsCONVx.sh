#!/bin/sh
echo "Stahování xxBigTits.m3u"
echo "Downloading xxBigTits.m3u"
...
sed -i "s/%/userbouquet.xxBigTits.m3u.tv/" /etc/enigma2/bouquets.tv 
...
echo "#NAME xxBigTits.m3u" > /etc/enigma2/userbouquet.xxBigTits.m3u.tv
cat CCcam3 >> /etc/enigma2/userbouquet.xxBigTits.m3u.tv
