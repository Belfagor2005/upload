#!/bin/sh
echo "stahuji TeensLoveHuge"
[ -d /tmp/test ] || mkdir -p /tmp/test
more /usr/lib/enigma2/python/Plugins/Extensions/OpenPanel/DATA/x  >> /etc/enigma2/bouquets.tv 
sed -i "s/%/userbouquet.TeensLoveHugexxx.m3u.tv/" /etc/enigma2/bouquets.tv 
curl -Lbk -m 4555 -m 6555 -k  https://www.redtube.com/channels/teenslovehugecocks?page=4 > /tmp/test/x1
cd /tmp/test
...
#################################################
echo "#NAME TeensLoveHugexxx.m3u" > /etc/enigma2/userbouquet.TeensLoveHugexxx.m3u.tv
cat seznam4 >> /etc/enigma2/userbouquet.TeensLoveHugexxx.m3u.tv
cd /
rm -rf /tmp/test
###########################################################################################################
