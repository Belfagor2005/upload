#!/bin/sh
echo "Stahování xxBlack.m3u"
echo "Downloading xxBlack.m3u"
...
sed -i "s/%/userbouquet.xxBlack.m3u.tv/" /etc/enigma2/bouquets.tv 

URL="https://www.eporner.com/cat/interracial/";
# Files
TMP=`mktemp -d`
cd / ${TMP}
...
echo "#NAME xxBlack.m3u" > /etc/enigma2/userbouquet.xxBlack.m3u.tv
cat CCcam3 >> /etc/enigma2/userbouquet.xxBlack.m3u.tv
