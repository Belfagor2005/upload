...
sed -i "s/%/userbouquet.BLACKEDRAWxxx.m3u.tv/" /etc/enigma2/bouquets.tv 
...
#################################################
echo "#NAME BLACKEDRAWxxx.m3u" > /etc/enigma2/userbouquet.BLACKEDRAWxxx.m3u.tv
cat seznam4 >> /etc/enigma2/userbouquet.BLACKEDRAWxxx.m3u.tv
cd /
rm -rf /tmp/test
###########################################################################################################
