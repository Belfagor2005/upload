...
sed -i "s/%/userbouquet.BLACKEDxx.m3u.tv/" /etc/enigma2/bouquets.tv 
...
#################################################
echo "#NAME BLACKEDxx.m3u" > /etc/enigma2/userbouquet.BLACKEDxx.m3u.tv
cat seznam4 >> /etc/enigma2/userbouquet.BLACKEDxx.m3u.tv
cd /
rm -rf /tmp/test
###########################################################################################################
