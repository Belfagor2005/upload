#!/bin/sh
echo "Stahování xxLesbians.m3u"
echo "Downloading xxLesbians.m3u"
...
sed -i "s/%/userbouquet.xxLesbians.m3u.tv/" /etc/enigma2/bouquets.tv 

URL="https://www.eporner.com/cat/lesbians/";
# Files
TMP=`mktemp -d`
cd / ${TMP}
...
sed 'N0,$!N;s/\n/ /' CCcam2 > CCcam3
sed -i 's# data-st="#/720/#g' CCcam3
sed -i '/video-/s/:/-720p.mp4/g' CCcam3
...
echo "#NAME xxLesbians.m3u" > /etc/enigma2/userbouquet.xxLesbians.m3u.tv
cat CCcam3 >> /etc/enigma2/userbouquet.xxLesbians.m3u.tv
