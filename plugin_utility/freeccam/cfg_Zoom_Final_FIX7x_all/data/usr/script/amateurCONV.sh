#!/bin/sh
echo "Stahování xxxAmateur.m3u"
echo "Downloading xxxAmateur.m3u"
...
sed -i "s/%/userbouquet.xxxAmateur.m3u.tv/" /etc/enigma2/bouquets.tv 
...
echo "#NAME xxxAmateur.m3u" > /etc/enigma2/userbouquet.xxxAmateur.m3u.tv
cat CCcam3 >> /etc/enigma2/userbouquet.xxxAmateur.m3u.tv
