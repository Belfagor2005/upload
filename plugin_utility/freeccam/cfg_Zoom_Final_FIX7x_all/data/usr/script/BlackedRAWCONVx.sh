...
#################################################
echo "#NAME BLACKEDRAWxx.m3u" > /etc/enigma2/userbouquet.BLACKEDRAWxx.m3u.tv
cat seznam4 >> /etc/enigma2/userbouquet.BLACKEDRAWxx.m3u.tv
cd /
rm -rf /tmp/test
###########################################################################################################
