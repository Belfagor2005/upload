#!/bin/sh
echo "Stahování xxxTeen.m3u"
echo "Downloading xxxTeen.m3u"
...
sed -i "s/%/userbouquet.xxxTeen.m3u.tv/" /etc/enigma2/bouquets.tv 
...
echo "#NAME xxxTeen.m3u" > /etc/enigma2/userbouquet.xxxTeen.m3u.tv
cat CCcam3 >> /etc/enigma2/userbouquet.xxxTeen.m3u.tv
