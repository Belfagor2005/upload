#!/bin/sh
echo "Stahování xxBigDick.m3u"
echo "Downloading xxBigDick.m3u"
...
sed -i "s/%/userbouquet.xxBigDick.m3u.tv/" /etc/enigma2/bouquets.tv 
...
echo "#NAME xxBigDick.m3u" > /etc/enigma2/userbouquet.xxBigDick.m3u.tv
cat CCcam3 >> /etc/enigma2/userbouquet.xxBigDick.m3u.tv
