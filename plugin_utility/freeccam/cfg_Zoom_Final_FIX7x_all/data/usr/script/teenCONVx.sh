#!/bin/sh
echo "Stahování xxTeen.m3u"
echo "Downloading xxTeen.m3u"
...
sed -i "s/%/userbouquet.xxTeen.m3u.tv/" /etc/enigma2/bouquets.tv 

URL="https://www.eporner.com/cat/teens/";
# Files
TMP=`mktemp -d`
cd / ${TMP}
...
echo "#NAME xxTeen.m3u" > /etc/enigma2/userbouquet.xxTeen.m3u.tv
cat CCcam3 >> /etc/enigma2/userbouquet.xxTeen.m3u.tv
