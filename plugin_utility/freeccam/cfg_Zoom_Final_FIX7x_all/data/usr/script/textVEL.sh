#!/bin/sh
echo "switching TEXT to MOD... ZOOM"
rm -rf /usr/lib/enigma2/python/Plugins/Extensions/OpenPanel/OpenPanelList.py
cp /usr/lib/enigma2/python/Plugins/Extensions/OpenPanel/DATA/OpenPanelListVEL.py /usr/lib/enigma2/python/Plugins/Extensions/OpenPanel/OpenPanelList.py
echo ""
echo ""
...
echo ""
sed -i '/textVEL.sh" confirmation="true" shortcut="blue"/s/" target="/ (OK)" target="/g' /etc/openpanel.xml
echo ""
