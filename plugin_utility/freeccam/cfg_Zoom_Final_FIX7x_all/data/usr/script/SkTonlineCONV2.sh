...
sed -i "s/%/userbouquet.SkTonline288.m3u.tv/" /etc/enigma2/bouquets.tv 
...
echo "#NAME SkTonline288.m3u" > /etc/enigma2/userbouquet.SkTonline288.m3u.tv
cat /tmp/test/Rus10.m3u >> /etc/enigma2/userbouquet.SkTonline288.m3u.tv
rm -rf /tmp/test
cd /
