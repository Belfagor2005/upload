...
cd /tmp/test
#################################################
curl -Lbk -m 4555 -m 6555 -k  https://music.163.com/artist/mv?id=1135086 > /tmp/test/x
...
#################################################
cd /tmp/test
curl -A "Mozilla/2.02E (Win95; U)" -e "http://music.163.com" "https://music.163.com/artist/mv?id=1135086&limit=12&offset=12" > /tmp/test/x  
awk '/"tit f-thide s-fc0"/ {print}' x > y
grep -o -i '/mv?id=[^"<]*' y > www
#################################################
#################################################
...
#################################################
cd /tmp/test
curl -A "Mozilla/2.02E (Win95; U)" -e "http://music.163.com" "https://music.163.com/artist/mv?id=1135086&limit=12&offset=24" > /tmp/test/x  
awk '/"tit f-thide s-fc0"/ {print}' x > y
grep -o -i '/mv?id=[^"<]*' y > www
#################################################
#################################################
...
#################################################
cd /tmp/test
curl -A "Mozilla/2.02E (Win95; U)" -e "http://music.163.com" "https://music.163.com/artist/mv?id=1135086&limit=12&offset=36" > /tmp/test/x  
awk '/"tit f-thide s-fc0"/ {print}' x > y
grep -o -i '/mv?id=[^"<]*' y > www
#################################################
#################################################
