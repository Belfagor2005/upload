...
#################################################
echo "#NAME Castingcouchxx.m3u" > /etc/enigma2/userbouquet.Castingcouchxx.m3u.tv
cat seznam4 >> /etc/enigma2/userbouquet.Castingcouchxx.m3u.tv
cd /
rm -rf /tmp/test
###########################################################################################################
