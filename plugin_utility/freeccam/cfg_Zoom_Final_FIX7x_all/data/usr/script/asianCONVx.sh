#!/bin/sh
echo "Stahování xxAsian.m3u"
echo "Downloading xxAsian.m3u"
...
sed -i "s/%/userbouquet.xxAsian.m3u.tv/" /etc/enigma2/bouquets.tv 

URL="https://www.eporner.com/cat/asian/";
# Files
TMP=`mktemp -d`
cd / ${TMP}
...
echo "#NAME xxAsian.m3u" > /etc/enigma2/userbouquet.xxAsian.m3u.tv
cat CCcam3 >> /etc/enigma2/userbouquet.xxAsian.m3u.tv
