...
sed -i "s/%/userbouquet.UnitedKingdom.m3u.tv/" /etc/enigma2/bouquets.tv 

echo "Stahování UnitedKingdom.m3u"
echo "Downloading UnitedKingdom.m3u"
curl  -k -Lbk -A -k -m 8 -m 52 -s  https://gitee.com/jjm2473/iptv/blob/master/channels/uk.m3u	 > /tmp/test/x
...
cat /tmp/test/x2 > /IPTV/World/UnitedKingdom.m3u
#########################################
cd /
rm -rf /tmp/test
echo ""
echo "converter UnitedKingdom.m3u for Enigma"
sleep 1
echo "start"
[ -d /tmp/test ] || mkdir -p /tmp/test
cp /IPTV/World/UnitedKingdom.m3u /tmp/test/Ru.m3u
...
echo "#NAME UnitedKingdom.m3u" > /etc/enigma2/userbouquet.UnitedKingdom.m3u.tv
cat /tmp/test/Rus10.m3u >> /etc/enigma2/userbouquet.UnitedKingdom.m3u.tv
rm -rf /tmp/test
cd /
