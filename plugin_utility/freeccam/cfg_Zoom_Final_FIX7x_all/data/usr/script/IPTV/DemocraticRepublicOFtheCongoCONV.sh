...
sed -i "s/%/userbouquet.DemocraticRepublicOFtheCongo.m3u.tv/" /etc/enigma2/bouquets.tv 

echo "Stahování DemocraticRepublicOFtheCongo.m3u"
echo "Downloading DemocraticRepublicOFtheCongo.m3u"
curl  -k -Lbk -A -k -m 8 -m 52 -s  https://gitee.com/jjm2473/iptv/blob/master/channels/cd /.m3u	 > /tmp/test/x
...
cat /tmp/test/x2 > /IPTV/World/DemocraticRepublicOFtheCongo.m3u
#########################################
cd /
rm -rf /tmp/test
echo ""
echo "converter DemocraticRepublicOFtheCongo.m3u for Enigma"
sleep 1
echo "start"
[ -d /tmp/test ] || mkdir -p /tmp/test
cp /IPTV/World/DemocraticRepublicOFtheCongo.m3u /tmp/test/Ru.m3u
...
echo "#NAME DemocraticRepublicOFtheCongo.m3u" > /etc/enigma2/userbouquet.DemocraticRepublicOFtheCongo.m3u.tv
cat /tmp/test/Rus10.m3u >> /etc/enigma2/userbouquet.DemocraticRepublicOFtheCongo.m3u.tv
rm -rf /tmp/test
cd /
