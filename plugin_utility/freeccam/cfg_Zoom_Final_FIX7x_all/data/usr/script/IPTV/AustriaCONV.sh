...
sed -i "s/%/userbouquet.Austria.m3u.tv/" /etc/enigma2/bouquets.tv 

echo "Stahování Austria.m3u"
echo "Downloading Austria.m3u"
curl  -k -Lbk -A -k -m 8 -m 52 -s  https://gitee.com/jjm2473/iptv/blob/master/channels/at.m3u	 > /tmp/test/x
