...
sed -i "s/%/userbouquet.BosniaAndHerzegovina.m3u.tv/" /etc/enigma2/bouquets.tv 

echo "Stahování BosniaAndHerzegovina.m3u"
echo "Downloading BosniaAndHerzegovina.m3u"
curl  -k -Lbk -A -k -m 8 -m 52 -s  https://gitee.com/jjm2473/iptv/blob/master/channels/ba.m3u	 > /tmp/test/x
...
cat /tmp/test/x2 > /IPTV/World/BosniaAndHerzegovina.m3u
#########################################
cd /
rm -rf /tmp/test
echo ""
echo "converter BosniaAndHerzegovina.m3u for Enigma"
sleep 1
echo "start"
[ -d /tmp/test ] || mkdir -p /tmp/test
cp /IPTV/World/BosniaAndHerzegovina.m3u /tmp/test/Ru.m3u
...
echo "#NAME BosniaAndHerzegovina.m3u" > /etc/enigma2/userbouquet.BosniaAndHerzegovina.m3u.tv
cat /tmp/test/Rus10.m3u >> /etc/enigma2/userbouquet.BosniaAndHerzegovina.m3u.tv
rm -rf /tmp/test
cd /
