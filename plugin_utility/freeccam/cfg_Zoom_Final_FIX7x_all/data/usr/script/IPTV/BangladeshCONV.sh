...
sed -i "s/%/userbouquet.Bangladesh.m3u.tv/" /etc/enigma2/bouquets.tv 

echo "Stahování Bangladesh.m3u"
echo "Downloading Bangladesh.m3u"
curl  -k -Lbk -A -k -m 8 -m 52 -s  https://gitee.com/jjm2473/iptv/blob/master/channels/bd.m3u	 > /tmp/test/x
...
cat /tmp/test/x2 > /IPTV/World/Bangladesh.m3u
#########################################
cd /
rm -rf /tmp/test
echo ""
echo "converter Bangladesh.m3u for Enigma"
sleep 1
echo "start"
[ -d /tmp/test ] || mkdir -p /tmp/test
cp /IPTV/World/Bangladesh.m3u /tmp/test/Ru.m3u
...
echo "#NAME Bangladesh.m3u" > /etc/enigma2/userbouquet.Bangladesh.m3u.tv
cat /tmp/test/Rus10.m3u >> /etc/enigma2/userbouquet.Bangladesh.m3u.tv
rm -rf /tmp/test
cd /
