...
sed -i "s/%/userbouquet.Jamaica.m3u.tv/" /etc/enigma2/bouquets.tv 

echo "Stahování Jamaica.m3u"
echo "Downloading Jamaica.m3u"
curl  -k -Lbk -A -k -m 8 -m 52 -s  https://gitee.com/jjm2473/iptv/blob/master/channels/jm.m3u	 > /tmp/test/x
...
cat /tmp/test/x2 > /IPTV/World/Jamaica.m3u
#########################################
cd /
rm -rf /tmp/test
echo ""
echo "converter Jamaica.m3u for Enigma"
sleep 1
echo "start"
[ -d /tmp/test ] || mkdir -p /tmp/test
cp /IPTV/World/Jamaica.m3u /tmp/test/Ru.m3u
...
echo "#NAME Jamaica.m3u" > /etc/enigma2/userbouquet.Jamaica.m3u.tv
cat /tmp/test/Rus10.m3u >> /etc/enigma2/userbouquet.Jamaica.m3u.tv
rm -rf /tmp/test
cd /
