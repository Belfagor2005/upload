#!/bin/sh
echo "Stahování xxxAsian.m3u"
echo "Downloading xxxAsian.m3u"
...
sed -i "s/%/userbouquet.xxxAsian.m3u.tv/" /etc/enigma2/bouquets.tv 
...
echo "#NAME xxxAsian.m3u" > /etc/enigma2/userbouquet.xxxAsian.m3u.tv
cat CCcam3 >> /etc/enigma2/userbouquet.xxxAsian.m3u.tv
