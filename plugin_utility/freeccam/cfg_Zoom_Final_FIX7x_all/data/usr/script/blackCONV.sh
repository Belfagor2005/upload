#!/bin/sh
echo "Stahování xxxBlack.m3u"
echo "Downloading xxxBlack.m3u"
...
sed -i "s/%/userbouquet.xxxBlack.m3u.tv/" /etc/enigma2/bouquets.tv 
...
echo "#NAME xxxBlack.m3u" > /etc/enigma2/userbouquet.xxxBlack.m3u.tv
cat CCcam3 >> /etc/enigma2/userbouquet.xxxBlack.m3u.tv
