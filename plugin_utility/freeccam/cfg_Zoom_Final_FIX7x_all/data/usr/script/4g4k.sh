...
curl curl  --limit-rate 35K -Lbk -m 4555 -m 6555 -k -s -d 'Username='$PATH_J_XM1'&Password='$PATH_J_XM2'&addf=2 Days Free Cccam' -X POST  https://4g4k.top/freecccam/index.php > /tmp/test/CCcam
