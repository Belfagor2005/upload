...
sed -i "s/%/userbouquet.Castingcouchxxx.m3u.tv/" /etc/enigma2/bouquets.tv 
...
#################################################
echo "#NAME Castingcouchxxx.m3u" > /etc/enigma2/userbouquet.Castingcouchxxx.m3u.tv
cat seznam4 >> /etc/enigma2/userbouquet.Castingcouchxxx.m3u.tv
cd /
rm -rf /tmp/test
###########################################################################################################
