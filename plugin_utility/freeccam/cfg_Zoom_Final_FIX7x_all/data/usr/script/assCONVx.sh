#!/bin/sh
echo "Stahování xxBigAss.m3u"
echo "Downloading xxBigAss.m3u"
...
sed -i "s/%/userbouquet.xxBigAss.m3u.tv/" /etc/enigma2/bouquets.tv 

URL="https://www.eporner.com/cat/big-ass/";
# Files
TMP=`mktemp -d`
cd / ${TMP}
...
echo "#NAME xxBigAss.m3u" > /etc/enigma2/userbouquet.xxBigAss.m3u.tv
cat CCcam3 >> /etc/enigma2/userbouquet.xxBigAss.m3u.tv
