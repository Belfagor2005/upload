#!/bin/sh
echo "Stahování xxxBigAss.m3u"
echo "Downloading xxxBigAss.m3u"
...
sed -i "s/%/userbouquet.xxxBigAss.m3u.tv/" /etc/enigma2/bouquets.tv 
...
echo "#NAME xxxBigAss.m3u" > /etc/enigma2/userbouquet.xxxBigAss.m3u.tv
cat CCcam3 >> /etc/enigma2/userbouquet.xxxBigAss.m3u.tv
