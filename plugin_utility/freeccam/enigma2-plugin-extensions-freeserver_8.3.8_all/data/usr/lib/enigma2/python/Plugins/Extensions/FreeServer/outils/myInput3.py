...
BFNAME= 'userbouquet.IPTVWORLD35.tv'
LastScanned= 'userbouquet.LastScanned.tv'
M3UPATH= '/tmp/IPTVWORLD35.m3u'
m3ufile= 'IPTVWORLD35'
WGET='wget --no-check-certificate'
BOUQUETSPATH='/etc/enigma2/bouquets.tv'
E2SETTINGSPATH='/etc/enigma2'
url2="https://khabyhosting.com/clientarea.php?action=productdetails"
#url22='https://i.imgur.com/3IRCbEZ.jpg'
url22='https://i.imgur.com/3hIOlWv.png'
services_url='https://khabyhosting.com/clientarea.php?action=services'
################################################################################
...
print("Android APP GTV APK :",'https://u.nu/nom9')
...
Post_Hdr={'User-Agent':'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/64.0.3282.140 Safari/537.36 Edge/18.17763',
          ...
          'Referer':'https://khabyhosting.com/cart.php',
          'Accept-Encoding':'gzip'}#, deflate, br'}

def cleanTMP():
    print("Clean tmp folder")
    print(LINE)
    os.system('rm -r %s > /dev/null 2>&1 && rm -f %s > /dev/null 2>&1' % (M3UPATH, LINKFILE))  # alphatest="blend" borderWidth="2"

class myInput3(Screen):
    skinfhd = '''
<screen position="center,center" size="975,650" title="Main Menu" backgroundColor="#10101010" flags="wfNoBorder">
  <widget source="Title" position="5,5" size="734,47" render="Label" font="Regular;28" foregroundColor="#00ffffff" transparent="1" halign="center"/>
  <widget name="icon" render="Pixmap" pixmap="/tmp/myPic.png" zPosition="5" position="300,60" size="350,250" backgroundColor="#00000000"/>
  <widget source="global.CurrentTime" render="Label" position="740,10" size="230,30" font="Regular;24" zPosition="2" foregroundColor="#ff404040" backgroundColor="#ff202020" halign="center" transparent="1">
    <convert type="ClockToText">Format %H:%M:%S</convert>
  </widget>
  <widget name="status" position="9,328" size="961,162" backgroundColor="#10101010" foregroundColor="#00ffffff" font="Regular;18"/>
  <widget source="key_red" render="Label" position="100,580" size="200,40" zPosition="2" valign="center" halign="center" font="Regular;22" transparent="0" foregroundColor="#00ffffff" backgroundColor="#ff033e"/>
  <widget source="key_green" render="Label" position="315,580" size="200,40" zPosition="3" valign="center" halign="center" font="Regular;22" transparent="0" foregroundColor="#00ffffff" backgroundColor="#00389416"/>
  <widget source="key_yellow" render="Label" position="500,580" size="200,40" zPosition="2" valign="center" halign="center" font="Regular;22" transparent="0" foregroundColor="#00ffffff" backgroundColor="#fad02c"/>
  <widget source="key_blue" render="Label" position="725,580" size="200,40" zPosition="3" valign="center" halign="center" font="Regular;22" foregroundColor="#00ffffff" backgroundColor="#002AFF"/>
  <widget name="HelpWindow" position="0,0" size="1,1" alphatest="on" foregroundColor="#00ffffff" transparent="1" zPosition="6"/>
</screen>'''
    skinhd = '''
<screen position="center,center" size="975,650" title="Main Menu" backgroundColor="#10101010" flags="wfNoBorder">
  <widget source="Title" position="5,5" size="794,55" render="Label" font="Regular;28" foregroundColor="#00ffffff" transparent="1" halign="center"/>
  <widget name="icon" render="Pixmap" pixmap="/tmp/myPic.png" zPosition="5" position="300,70" size="350,250" borderColor="#00ffffff" backgroundColor="#00000000"/>
  <widget source="global.CurrentTime" render="Label" position="735,10" size="230,30" font="Regular;24" zPosition="2" foregroundColor="#ff404040" backgroundColor="#ff202020" halign="center" transparent="1">
    <convert type="ClockToText">Format %H:%M:%S</convert>
  </widget>
  <widget name="status" position="9,328" size="961,162" backgroundColor="#10101010" foregroundColor="#00ffffff" font="Regular;18"/>
  <widget source="key_red" render="Label" position="55,600" size="200,40" zPosition="2" valign="center" halign="center" font="Regular;22" transparent="0" foregroundColor="#00ffffff" backgroundColor="#ff033e"/>
  <widget source="key_green" render="Label" position="488,600" size="200,40" zPosition="2" valign="center" halign="center" font="Regular;22" transparent="0" foregroundColor="#00ffffff" backgroundColor="#00389416"/>
  <widget source="key_yellow" render="Label" position="273,600" size="200,40" zPosition="2" valign="center" halign="center" font="Regular;22" transparent="0" foregroundColor="#00ffffff" backgroundColor="#fad02c"/>
  <widget source="key_blue" render="Label" position="705,600" size="200,40" zPosition="2" valign="center" halign="center" font="Regular;22" transparent="0" foregroundColor="#00ffffff" backgroundColor="#002AFF"/>
  <widget name="HelpWindow" position="0,0" size="1,1" alphatest="on" foregroundColor="#00ffffff" transparent="1" zPosition="6"/>
</screen>'''  
    ...
    def __init__(self, session, useableChars=None, **kwargs):
        ...
        if dwidth == 1280:
            self.skin = myInput3.skinhd
        else:
            self.skin = myInput3.skinfhd
...
### End
        ...
        self['key_green'] = StaticText(_('vavoo'))
        self['key_blue'] = StaticText(_('vavoo++'))
        self['key_yellow'] = StaticText(_('autokey'))
        ...
        #post_account=s.post('https://khabyhosting.com/cart.php?a=add&pid=1',headers=Post_Hdr,data=post_data,verify=False,allow_redirects=True).content
        ...
        #data=s.get('https://khabyhosting.com/cart.php?a=view',verify=False,allow_redirects=True).text
        #regx='token" value="(.*?)"'
        #try:post_token=re.findall(regx,data, re.M|re.I)[0]
        #except:pass
        #print("POST TOKEN:",post_token)
        #s.headers.update({'token': post_token})
        #checkout_data='token='+post_token+'&submit=true&custtype=new&loginemail=&loginpassword=&firstname='+NAME_TARGET+'&lastname='+LAST_TARGET+'&email='+NAME_TARGET+rnd2+'@gmail.com&country-calling-code-phonenumber=1&phonenumber='+PHON_TARGET+'&companyname=&address1='+ADRS_TARGET+'&address2='+ADRS2_TARGET+'&city='+CITY_TARGET+'&state='+STATE_TARGET+'&postcode='+ZIP_TARGET+'&country=US&password='+RND_PASS+'&password2='+RND_PASS+'&applycredit=1&paymentmethod=directdebit&ccinfo=new&ccnumber=&ccexpirydate=&cccvv=&ccdescription=&notes=&marketingoptin=1'
        #post_account=s.post('https://khabyhosting.com/cart.php?a=checkout',headers=Post_Hdr,data=checkout_data,verify=False,allow_redirects=True).text
        #data=s.get(services_url,verify=False).text
        #regx='data-element-id="(.*?)"' 
        #service_id=re.findall(regx, data, re.M|re.I)[0]
        #data=s.post('https://www.tmtiptv.com/billing/clientarea.php?action=productdetails&id=%s'%service_id,headers=Post_Hdr,data=checkout_data,verify=False,allow_redirects=True).text
        #regx='name="token" value="(.*?)"'
        ...
        #SRV_HDR={'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:83.0) Gecko/20100101 Firefox/83.0',
                 #'Accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,*/*;q=0.8',
                 #'Accept-Language': 'fr,fr-FR;q=0.8,en-US;q=0.5,en;q=0.3',
                 #'Referer': 'https://khabyhosting.com/clientarea.php?action=productdetails&id=%s'%service_id,
                 #'Content-Type': 'application/x-www-form-urlencoded',
                 #'Upgrade-Insecure-Requests': '1',
                 #'Accept-Encoding': 'gzip'}#gzip, deflate, br'
        #post_data=s.post('https://khabyhosting.com/clientarea.php?action=productdetails&id=%s'%service_id,headers=SRV_HDR,verify=False,allow_redirects=True).text
        #if "IPTV" in post_data:
            #print("Success Target Found !!!")        
            #regx = '''<a id="m3u_output" target="_blank" data-url="(.*?)"  href'''   
            #regx1 = '''username=(.*?)&password'''
            #regx2 = '''password=(.*?)&output''' 
            #cfg_conf ="App Username:  "+re.findall(regx1,post_data)[0]+'\n\t\t'+"App Password:  "+re.findall(regx2,post_data)[0]
            #link="'"+re.findall(regx, post_data, re.M|re.I)[0].replace('output=','output=ts&type=m3u')+"'"
            #if link:
                #print("link :", link)
                #print(("App Detail tmp/link2 :", cfg_conf))
                #with open(LINKFILE, "a") as f: f.write(link)
                #with open(LINKFILE2, "a") as f: f.write(cfg_conf)

                                        
            #else:
                #print('nada_link')
                #return 'nada_link'
        msg='\t\tvavoo downlowd install vavoo' + '\n\t\tvavoo++  Sids  Germany France Italy Span Epg and Picons \n\t\tAuto Key Update evry 10mns at each reboot...\n\t\tautokey every 10 minutes' + '\n\n\n\t\t\thappy viewing'
...
#        self["input"].handleAscii(getPrevAsciiCode())
    ...
    def KeyGreen(self):
        ...
        cmdlist.append("%s https://ia801703.us.archive.org/18/items/freecccamserver_201906/freecccamserver50.sh -qO - | /bin/sh" % self.wget)
        self.session.open(Console3, title='vavoosid', cmdlist=cmdlist, finishedCallback=None)
        self.close(True)
                
    def KeyBlue(self):
        cmdlist = []
        cmdlist.append("%s -qO - '" % self.wget + "'")
        cmdlist.append("%s https://ia903104.us.archive.org/0/items/freecccamserver/vavoo.sh -qO - | /bin/sh" % self.wget)
        self.session.open(Console3, title='vavoo', cmdlist=cmdlist, finishedCallback=None)
        self.close(True)
        
    def KeyYellow(self):
        cmdlist = []
        cmdlist.append("%s -qO - '" % self.wget + "'")
        cmdlist.append("%s https://ia803104.us.archive.org/0/items/freecccamserver/autokey.sh -qO - | /bin/sh" % self.wget)
        self.session.open(Consolo, title='autokey', cmdlist=cmdlist, finishedCallback=None)
        self.close(True)
    ...
    #def askForWord(self):
                ...
                #regx='data-element-id="(.*?)"' 
                #service_id=re.findall(regx, data, re.M|re.I)[0]
                #data=s.get('https://guerrillahosting.net/billing/clientarea.php?action=productdetails&id=%s'%service_id,allow_redirects=True,verify=False).text
                #regx='token" value="(.*?)"'
                #try:token_=re.findall(regx,data, re.M|re.I)[0]
                #except:pass
                #params='token='+token_+'&id='+service_id+'&customAction=manage'
                #SRV_HDR={'User-Agent': 'Mozilla/5.0 (Windows NT 6.1; rv:86.0) Gecko/20100101 Firefox/86.0',
                         #'Host': 'guerrillahosting.net',
                         #'Connection': 'keep-alive',
                         #'Accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,*/*;q=0.8',
                         #'Accept-Language': 'fr,fr-FR;q=0.8,en-US;q=0.5,en;q=0.3',
                         #'Referer': 'https://guerrillahosting.net/billing/clientarea.php?action=productdetails&id=%s'%service_id,
                ...
                #print post_data
                    ...
                    #regx2 = '''newPassword" value="(.*?)" style'''  
                    #regx3 = '''<a target="_blank" href='(.*?)' style="'''  
                    #msg='\nUpdate successfully You Received  ' + str(ChServers) + ' Servers @mino60'
                    #link = re.findall(regx, post_data, re.M|re.I)[0].replace("playlist","Username Password :").replace("/","    ")
                    #link = link.decode('utf-8')
                    #self.session.open(MessageBox, link + '\nDownload Android APP GTV APK\n' + '\nhttps://u.nu/nom9\n' + '\nMore details on /tmp/link2\n', type=MessageBox.TYPE_INFO)
                    #if link:
                       #print(("link :", link))
                       #with open(LINKFILE_1, "a") as f:
                               #f.write(link)
                    #else:
                       #print('nada_link')
                       #return('nada_link')
             ...
             #else: print("Android APP GTV APK :",'https://u.nu/nom9')
