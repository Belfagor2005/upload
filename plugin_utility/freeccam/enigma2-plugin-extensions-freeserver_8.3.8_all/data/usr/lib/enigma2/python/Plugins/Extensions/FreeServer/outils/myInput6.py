...
LINKFILE000= '/tmp/test000'
LINKFILE0= '/tmp/test'
LINKFILE= '/tmp/link'
LINKFILE2= '/tmp/code'
LINKFILE2_1= '/tmp/post_token'
LINKFILE2_2= '/tmp/EMAIL_TARGET'
LINKFILE3_1= '/tmp/myPic1.png'
LINKFILE3= '/tmp/myPic.png'
LINKFILE_1= '/tmp/link2'
TMPOUTPUTDATA= '/tmp/dateoutTMP'
BFNAME= 'userbouquet.IPTVWORLD37.tv'
LastScanned= 'userbouquet.LastScanned.tv'
M3UPATH= '/tmp/IPTVWORLD37.m3u'
m3ufile= 'IPTVWORLD37'
WGET='wget --no-check-certificate'
BOUQUETSPATH='/etc/enigma2/bouquets.tv'
E2SETTINGSPATH='/etc/enigma2'
url2="https://streamingtvnow.com/clients/clientarea.php?action=productdetails"
url22='https://streamingtvnow.com/clients/includes/verifyimage.php'
services_url='https://streamingtvnow.com/clients/clientarea.php?action=services'
services_url2='https://generator.email/'
################################################################################    
...
RND_EMAIL=['@cggup.com','@c63q.com','@54.mk','@tatotzracing.com','@rackabzar.com','@outlookbox.me','@ikanchana.com','@inkashop.org','@inkashop.org','@boranora.com','@indonesiaberseri.com','@getcashstash.com','@btcmod.com','@iloveitaly.tk','@beinger.me','@kitchen-tvs.ru','@btcmod.com','@hotmail.red','@goldinbox.net','@njhdes.xyz','emailgap.com',    
           '@xilinous.xyz','@indmeds.com','@adios.email','@bukan.es','@justademo.cf','@gmailos.com','@saging.tk','@s-ly.me','@saging.tk','@picsviral.net','@myxl.live','@ulummky.com','@filevino.com','@24hinbox.com','@cggup.com','@btcmod.com','@dmxs8.com','@shopmizi.com','@yt-google.com','@tuku26012023.xyz','@gawe.works','@king.buzz']         
#RND_EMAIL=['@otpku.com','@clonefb247-net.gq','@problemstory.us','@xilinous.xyz','@email-temp.com','@skillion.org','@serversiap.com','@wacopyingy.com','@perlededed.online','@rackabzar.com','@btcmod.com','@aesth.tk','@starux.de','@bukanimers.com','@roomsystem.us','@roomsystem.us','@serversiap.com','@packiu.com','@fviatool.com','@okocewakaf.com','@fickdate-lamou.de','@keboloro.me','@ts5.xyz','@alvinneo.com','@aesth.tk','@saxophonexltd.com',    
            #'@tech-mail.cf','@evoiceeeeee.blog','@cashbackr.com','@comohacer.club','@dexamail.com','@peler.tech','@stamberg.nl','@gawe.works','@serversiap.com','@falixiao.com','@wacopyingy.com','@themoneysinthelist.com','@fviatool.com','@usawisconsinnewyear.com','@marmaryta.email','@hula3s.com','@tatotzracing.com','@icmarottabasile.it','@onlinecmail.com','@goldinbox.net','@credit-finder.info','@plexvenet.com','@haanhwedding.com','@boranora.com','@rio2000.tk','@aliorder.pro']         
#RND_EMAIL=['@gtkesh.com','@innoberg.com','@kitchen-tvs.ru','@stinkypoopoo.com','@colevillecapital.com','@24mail.top','@packiu.com','@filevino.com','@kimachina.com','@mphaotu.com','@thekangsua.com','@gtkesh.com','@businessmoney.us','@liquidlogisticsmanagement.com','@stinkypoopoo.com','@kitchen-tvs.ru','@squaresilk.com','@btcmod.com','@dmxs8.com','@stinkypoopoo.com','@galvanitrieste.it','@ffo.kr','@alvinneo.com','@yagatekimi.com']
#RND_EMAIL=['@o0i.es','@stinkypoopoo.com','@colevillecapital.com','@ffo.kr','@vietkevin.com','@kitchen-tvs.ru','@mailsaviors.com','@freeallapp.com','@gmailni.com','@mphaotu.com','@dmxs8.com','@pickuplanet.com','@backwis.com','@omtecha.com','@gasssmail.com']     
#RND_AR=['@'] 
chars = string.digits
RND_ID  =  ''.join(choice(chars) for _ in range(4))
RND_PASS=  ''.join(choice(chars) for _ in range(9))
#EMAIL_TARGET=NAME_TARGET+str(RND_ID)+random.choice(RND_EMAIL)
RND_TARGET=str(RND_ID)
#AR_TARGET=random.choice(RND_AR)
#host_url='https://generator.email/'+EMAIL_TARGET
#host_url='https://emailfake.com/'+EMAIL_TARGET
#host_url="https://www.temp-mails.com/lan/id/rec_email"
print("Password:",RND_PASS)
#print ("EMail Target:",EMAIL_TARGET)
#print "Country Target:",COUNT_TARGET
...
#host_url2='https://generator.email/imbox/'
#host_url2='https://getnada.com'
...
Post_Hdr={'User-Agent':'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/64.0.3282.140 Safari/537.36 Edge/18.17763',
          ...
          'Referer':'https://zazyhost.com/billing/cart.php',
...
<widget name="HelpWindow" position="200,370" size="1,1" alphatest="on" foregroundColor="#00ffffff" transparent="1" zPosition="6" />
    ...
    def __init__(self, session, useableChars=None, **kwargs):
        ...
        if dwidth == 1280:
            self.skin = myInput6.skinhd
        else:
            self.skin = myInput6.skinfhd
...
### End
        ...
        data=s.get(services_url2,verify=False).text
        regx='''normal;">(.*?)</p></div><div class'''
        email= re.findall(regx, data, re.M|re.I)[0]
        EMAIL_TARGET=random.choice(RND_NAME)+str(RND_ID)+'@'+str(email)
        print ("EMail Target:",EMAIL_TARGET)
        host_url='https://generator.email/'+EMAIL_TARGET 
        with open(LINKFILE2_2, "a") as f: f.write(EMAIL_TARGET)   
        post_data2='customfield[75]=11&configure=true&i=0&submit=Continue'                             
        post_data='firstname='+NAME_TARGET+'&lastname='+LAST_TARGET+'&email='+NAME_TARGET+rnd2+'@gmail.com&country-calling-code-phonenumber=1&phonenumber='+PHON_TARGET+'&companyname=&address1='+ADRS_TARGET+'&address2='+ADRS_TARGET+'&city='+CITY_TARGET+'&state='+STATE_TARGET+'&postcode='+ZIP_TARGET+'&country=US&tax_id=&password='+RND_PASS+'&password2='+RND_PASS+'&applycredit=1&cccvv=&paymentmethod=payrequest&ccinfo=new&ccnumber=&ccexpirydate=&cccvv=&ccdescription=&notes=&marketingoptin=1&accepttos=I have read and agree to the&submit=Complete Order'
        post_account=s.post('https://streamingtvnow.com/clients/cart.php?a=add&pid=12',headers=Post_Hdr,data=post_data2,verify=False,allow_redirects=True).content
        post_account=s.post('https://streamingtvnow.com/clients/cart.php?a=confproduct&i=0',headers=Post_Hdr,data=post_data2,verify=False,allow_redirects=True).content
        #post_account=s.post('https://zazyhost.com/billing/cart.php?a=view',headers=Post_Hdr,data=post_data,verify=False).content
        data=s.get('https://streamingtvnow.com/clients/cart.php?a=view',verify=False,allow_redirects=True).text
        regx='token" value="(.*?)"'
        try:token=re.findall(regx,data, re.M|re.I)[0]
        except:pass
        print("POST TOKEN:",token)
        s.headers.update({'token': token})
        with open(LINKFILE2_1, "a") as f: f.write(token)
        checkout_data='token='+token+'&submit=true&custtype=new&loginemail=&loginpassword=&firstname='+NAME_TARGET+'&lastname='+LAST_TARGET+'&email='+EMAIL_TARGET+'&country-calling-code-phonenumber=1&phonenumber='+PHON_TARGET+'&companyname=&address1='+ADRS_TARGET+'&address2='+ADRS2_TARGET+'&city='+CITY_TARGET+'&state='+STATE_TARGET+'&postcode='+ZIP_TARGET+'&country=US&password='+RND_PASS+'&password2='+RND_PASS+'&applycredit=1&paymentmethod=banktransfer&ccinfo=new&ccnumber=&ccexpirydate=&cccvv=&ccdescription=&notes=&marketingoptin=1&code='
        post_account=s.post('https://streamingtvnow.com/clients/cart.php?a=checkout',headers=Post_Hdr,data=checkout_data,verify=False,allow_redirects=True).text
        ...
        #f.write(data)
        #os.system('wget --no-check-certificate -q -O- --trust-server-names %s > %s' % (url22, LINKFILE3_1))
        #r = s.get('https://myiptv.hurley-tv.me/includes/verifyimage.php',verify=False,allow_redirects=True).text
        #r = s.post(url22, stream = True,headers=Post_Hdr,data=post_data2,verify=False,allow_redirects=True).text
        #with open(LINKFILE3_1, "a") as f: f.write(r)
        #with open(LINKFILE3_1,'wb') as f:
                #shutil.copyfileobj(r.raw, f)
        r = s.get(url22,stream=True).content
        with open(LINKFILE3_1, 'wb') as f: f.write(r)
        data=s.get('https://streamingtvnow.com/clients/index.php?m=emailverification&verify=email',verify=False,allow_redirects=True).text
        regx='token" value="(.*?)"'
        try:post_token=re.findall(regx,data, re.M|re.I)[0]
        except:pass
        print("POST TOKEN:",post_token)
        s.headers.update({'token': post_token})
        prm='check_mail=1&email='+EMAIL_TARGET+'&token='+post_token+''
        post_data=s.post('https://streamingtvnow.com/clients/index.php?m=emailverification&verify=email',headers=Post_Hdr,data=prm,verify=False,allow_redirects=True).text
        parm='send_secode=1&email='+EMAIL_TARGET+'&token='+post_token+''
        post_data=s.post('https://streamingtvnow.com/clients/index.php?m=emailverification&verify=email',headers=Post_Hdr,data=parm,verify=False,allow_redirects=True).text
        os.system("rm -f %s" % LINKFILE)
        time.sleep(2)
        os.system('wget --no-check-certificate -q -O- --trust-server-names %s > %s' % (host_url, LINKFILE))
        with open(LINKFILE, 'r') as f:
            sdata = f.read()
            #with open(LINKFILE, "a") as f: f.write(sdata)
            regx='<p><strong>(.*?)</strong></p>'
            #regx='<p>Your code is (.*?)<br'
            #regx='<strong>(.*?)</strong></p><p>'
            code2=re.findall(regx, sdata, re.M|re.I)[0]
            print("Code2 :", code2)
            prms='check_secode=1&code='+code2+''
            print ("PRMS:",prms)
            post_data=s.post('https://streamingtvnow.com/clients/index.php?m=emailverification&verify=email',headers=Post_Hdr,data=prms,verify=False,allow_redirects=True).text
            #with open(LINKFILE0, "a") as f: f.write(post_data) &email='+EMAIL_TARGET+'
    ...
    def save(self):
        ...
        if pathExists(Distnt):
            ...
            if Password != '':
                ...
                #cmdlist.append("%s -qO - '" % self.wget + "'")
                #cmdlist.append("%s https://ia601508.us.archive.org/7/items/iptvworld-1/IPTVWORLD37.sh -qO - | /bin/sh" % self.wget)
                #self.session.open(Console3, title='IPTVWORLD37', cmdlist=cmdlist, finishedCallback=None)
                #self.close(True)
    ...
    def askForWord(self):
                ...
                if os.path.exists(LINKFILE2_1):
                   ...
                   for line in f.readlines():
                       id = line.strip('\n')
                       try:token = "{0}".format(id)
                       except:pass 
                if os.path.exists(LINKFILE2_1):
                   f = open(LINKFILE2_2, 'r')
                   for line in f.readlines():
                       id = line.strip('\n')
                       try:EMAIL_TARGET = "{0}".format(id)
                       except:pass 
                if os.path.exists(LINKFILE2):
                   f = open(LINKFILE2, 'r')
                   for line in f.readlines():
                ...
                os.system("rm -f %s" % LINKFILE)
                post_data=s.get('https://streamingtvnow.com/clients/clientarea.php?action=productdetails&id=%s'%service_id,allow_redirects=True,verify=False).text
                #with open(LINKFILE0, "a") as f: f.write(post_data)
                if "Services" in post_data:
                    print("Target Found !!!")
                    #for email in html_data:
                    regx = '''<p><h3>Username : (.*?)</h3></p>'''
                    regx2 = '''<p><h3>Password : (.*?)</h3></p>'''
                    #regx = '''<a id="m3u_output" data-url="(.*?)"'''
                    link=re.findall(regx,post_data, re.M|re.I)[0]
                    link2=re.findall(regx2,post_data, re.M|re.I)[0]+ '\nlink : http://stnlive.ltd:80' 
                    self.session.open(MessageBox, 'Username : ' + link + '\nPassword : ' + link2  + '\nDownload Android tivimate.apk\n' + '\nhttps://tvm.stn.bz/\n' + '\nMore details on /tmp/link2\n', type=MessageBox.TYPE_INFO)
                    if link:
                           print("link :", link)
                           print("link2 :", link2)
                           with open(LINKFILE2, "a") as f: f.write(link)
                           with open(LINKFILE2, "a") as f: f.write('\n'+link2)
                    else:
                           print('nada_link')
                           return 'nada_link'    
                return
