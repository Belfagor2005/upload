...
url22='https://khabyhosting.com/assets/img/logo.png'
...
<screen position="center,center" size="975,650" title="Main Menu" backgroundColor="#10101010" flags="wfNoBorder">
  ...
  <widget name="HelpWindow" position="0,0" size="1,1" alphatest="on" foregroundColor="#00ffffff" transparent="1" zPosition="6"/>
    ...
    def __init__(self, session, useableChars=None, **kwargs):
        ...
        if dwidth == 1280:
            self.skin = myInput4.skinhd
        else:
            self.skin = myInput4.skinfhd
...
### End
        ...
        self['key_green'] = StaticText(_('downlowd m3u'))
        self['key_blue'] = StaticText(_('downlowd app'))
        self['key_yellow'] = StaticText(_('downlowd plus'))
        ...
        msg='\t\tDownload Android APP Khaby Smart APK' + '\n\t\thttps://tinyurl.com/khabysmart' + str("\n\t\t"+cfg_conf) + '\n\n\n\t\t\thappy viewing'
...
#        self["input"].handleAscii(getPrevAsciiCode())
    ...
    def KeyGreen(self):
        ...
        self.session.open(Console3, title='IPTVWORLD35', cmdlist=cmdlist, finishedCallback=None)
        self.close(True)
                
    def KeyBlue(self):
        cmdlist = []
        cmdlist.append("%s -qO - '" % self.wget + "'")
        cmdlist.append("%s https://ia903000.us.archive.org/30/items/FreeServerinfo/khabysmart.apk > %s" % (self.wget, LINKFILE2)) 
        self.session.open(Console3, title='khabysmart', cmdlist=cmdlist, finishedCallback=None)
        self.close(True)
        
    def KeyYellow(self):
        cmdlist = []
        cmdlist.append("%s -qO - '" % self.wget + "'")
        cmdlist.append("%s https://ia601508.us.archive.org/7/items/iptvworld-1/IPTVWORLD035.sh -qO - | /bin/sh" % self.wget)
        self.session.open(Console3, title='IPTVWORLD035', cmdlist=cmdlist, finishedCallback=None)
        self.close(True)
