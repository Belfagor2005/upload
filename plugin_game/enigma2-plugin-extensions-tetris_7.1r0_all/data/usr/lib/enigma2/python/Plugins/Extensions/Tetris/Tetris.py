...
from enigma import eTimer, getDesktop  # , RT_HALIGN_CENTER, RT_VALIGN_CENTER, gFont
...
class TetrisBoard(object):
    ...
    def __init__(self, canvas):
        ...
        if os.path.exists('/var/lib/dpkg/info'):
            self.moveTimer_conn = self.moveTimer.timeout.connect(self.moveDown)
        else:
            self.moveTimer.callback.append(self.moveDown)
        self.moveTimer.start(150, 1)
...
class Board(Screen):
    if isFHD():
        print('is fhd----------------------------')
        skin = """
                <screen name="Tetrisfhd" position="60,70" size="1800,940" title="Tetris" backgroundColor="#101010">
                    <ePixmap position="0,0" size="1800,940" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/Tetris/pic/tetris.jpg" />
                    <widget source="canvas" render="Canvas" position="685 ,40" size="430,860" backgroundColor="#60ffffff" transparent="1" alphatest="blend" zPosition="2" />
                    ...
                    <ePixmap position="60,50" pixmap="skin_default/buttons/key_green.png" size="80,40" alphatest="blend" scale="1" zPosition="2" />
                    ...
                    <ePixmap position="60,100" pixmap="skin_default/buttons/key_red.png" size="80,40" alphatest="blend" scale="1" zPosition="2" />
