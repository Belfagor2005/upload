...
class iEcmInfo(Poll, Converter, object):
        ecmfile = 0
        emuname = 1
        caids = 2
        pids = 3
...
###############################################################################
                ...
                if self.type == self.emuname:
                        ...
                        nameser = []
                        #VIX
                        if os.path.exists(resolveFilename(SCOPE_PLUGINS, "SystemPlugins/ViX/SoftcamManager.pyc")):
                        ...
                        # BlackHole OE1.6
                                ...
                                try:
                                        ...
                                        return None
                        # Pure2     
                        elif os.path.exists("/etc/clist.list") and not os.path.exists("/usr/lib/enigma2/python/Plugins/Extensions/Manager/levisemu.py") and not os.path.exists("/usr/lib/enigma2/python/Plugins/Extensions/tvManager/data/clist.list"):
                                try:
