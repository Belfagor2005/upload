...
#EXAMPLE
#<widget source="Service" render="Label" position="1312,698" size="600,306" font="Regular; 30" #backgroundColor="background" transparent="1" noWrap="1" zPosition="1" foregroundColor="white" valign="top">
#<convert type="AglareEventName2">NextEventList</convert></widget>
...
class iEventName2(Converter, object):
    NAME = 0
    NAME_TWEAKED = 1
    SHORT_DESCRIPTION = 2
